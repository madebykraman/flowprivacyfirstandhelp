...
assert.match(index,/ritmi-overhaul\.css\?v=50/);
assert.match(index,/ritmi-enhancements\.js\?v=50/);
assert.match(sw,/ritmi-overhaul\.css\?v=50/);
assert.match(sw,/ritmi-enhancements\.js\?v=50/);
